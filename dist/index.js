...
var DayColumnPreview = function (_a) {
    ...
    return (jsxRuntime.jsxs("div", __assign({ className: "".concat(classNames.day, " ").concat(day), style: {
        ...
        }, onClick: function (e) { return onClick(e, rowHeight); } }, { children: [jsxRuntime.jsx("div", __assign({ className: classNames.day_title, style: { height: "".concat(rowHeight, "vh") } }, { children: getDayLabel(day) })), EventsList({
                events: events,
                day: day,
