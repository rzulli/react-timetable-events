...
var DayColumnPreview = function (_a) {
    ...
    return (jsxs("div", __assign({ className: "".concat(classNames.day, " ").concat(day), style: {
        ...
        }, onClick: function (e) { return onClick(e, rowHeight); }, onMouseDown: function (e) { return onMouseDown(e, rowHeight); }, onMouseUp: onMouseUp, onMouseMove: function (e) { return onMouseMove(e, rowHeight); } }, { children: [jsx("div", __assign({ className: classNames.day_title, style: { height: "".concat(rowHeight, "vh") } }, { children: getDayLabel(day) })), EventsList({
                events: events,
                day: day,
