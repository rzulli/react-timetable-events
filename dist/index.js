...
var DayColumnPreview = function (_a) {
    ...
    return (jsxRuntime.jsxs("div", __assign({ className: "".concat(classNames.day, " ").concat(day), style: {
        ...
        }, onClick: function (e) { return onClick(e, rowHeight); }, onMouseDown: function (e) { return onMouseDown(e, rowHeight); }, onMouseUp: onMouseUp, onMouseMove: function (e) { return onMouseMove(e, rowHeight); } }, { children: [jsxRuntime.jsx("div", __assign({ className: classNames.day_title, style: { height: "".concat(rowHeight, "vh") } }, { children: getDayLabel(day) })), EventsList({
                events: events,
                day: day,
    ...
    return range_1(hoursInterval.from, hoursInterval.to).map(function (hour) {
        return renderHour({
            ...
            defaultAttributes: {
                ...
                style: { height: "".concat(rowHeight, "vh") },
            },
            classNames: classNames,
        });
    });
...
var TimeTable = function (_a) {
    ...
    var _l = React__namespace.useState(0), rowHeight = _l[0], setRowHeight = _l[1];
    React__namespace.useEffect(function () {
        setRowHeight(getRowHeight(hoursInterval.from, hoursInterval.to));
    }, [hoursInterval]);
    return (jsxRuntime.jsxs("div", __assign({ className: classNames.time_table_wrapper }, { children: [jsxRuntime.jsxs("div", __assign({ className: classNames.day }, { children: [jsxRuntime.jsx("div", __assign({ className: classNames.day_title, style: { height: "".concat(rowHeight, "vh") } }, { children: timeLabel })), HoursList({ hoursInterval: hoursInterval, renderHour: renderHour, rowHeight: rowHeight })] })), Object.keys(events).map(function (day, index) {
...
exports.onMouseDownPreview = onMouseDownPreview;
exports.onMouseMovePreview = onMouseMovePreview;
exports.onMouseUpPreview = onMouseUpPreview;
